...
#ifdef STUB_X_LIST
/* Link-only: base/eval specs compile x_eval_list (x-eval.c) and
 * x_env_extend (x-env.c) but never call them -- they stub the list type and
 * the procedure/operative call paths that would. */
