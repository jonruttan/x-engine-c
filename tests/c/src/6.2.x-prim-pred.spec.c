...
static char *test_pred_eq(void)
{
	...
	/* Same object -> t */
	p_obj = x_mksatom(p_base, X_OBJ_FLAG_NONE, (x_int_t)42);
...
static char *test_pred_lt(void)
{
	...
	/* (< 3 5) -> t */
	p_args = x_mkspair(p_base, X_OBJ_FLAG_NONE, NULL,
		x_mkspair(p_base, X_OBJ_FLAG_NONE, x_mksatom(p_base, X_OBJ_FLAG_NONE, (x_int_t)3),
		x_mkspair(p_base, X_OBJ_FLAG_NONE, x_mksatom(p_base, X_OBJ_FLAG_NONE, (x_int_t)5), NULL)));
...
static char *test_pred_char_to_integer(void)
{
	...
	/* (char->integer #\A) -> 65 */
	p_args = x_mkspair(p_base, X_OBJ_FLAG_NONE, NULL,
		x_mkspair(p_base, X_OBJ_FLAG_NONE, x_mkchar(p_base, 'A'), NULL));
...
static char *test_pred_integer_to_char(void)
{
	...
	/* (integer->char 65) -> #\A */
	p_args = x_mkspair(p_base, X_OBJ_FLAG_NONE, NULL,
		x_mkspair(p_base, X_OBJ_FLAG_NONE, x_mksatom(p_base, X_OBJ_FLAG_NONE, (x_int_t)65), NULL));
